import { AlertTriangleIcon, ClockIcon, CheckIcon, Minimize2Icon } from "lucide-react";
...
export const ProjectsLegend = memo(
	({ showLegend, setShowLegend, filters, onFilterChange, compactMode, onCompactModeChange }: ProjectsLegendProps) => {
	...
	(prevProps, nextProps) => {
		return prevProps.showLegend === nextProps.showLegend && prevProps.filters === nextProps.filters && prevProps.compactMode === nextProps.compactMode;
	},
);
